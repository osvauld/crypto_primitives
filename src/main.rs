...
fn main() {
    ...
    // println!("Encrypted credentials: {:?}", encrypted_fields);
    ...
    println!("Encrypted Credential: {:?}", credentials);
    // Now call decrypt_credentials
    let decrypted_credentials = decrypt_credentials(credentials);
    ...
    //     })
    //     .collect();
    // println!("Encrypted Credential: {:?}", credential_fields);
    // // Now call decrypt_fields
    // let decrypted_credentials = decrypt_fields(credential_fields);
